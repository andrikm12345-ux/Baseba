...
4. Минимальные планки для публикации:
   - ML / RL (фора): расхождение ≥ 3%, уверенность ≥ 0.56, кэф ≥ 1.9
   - TOTAL: расхождение ≥ 6%, уверенность ≥ 0.62, кэф ≥ 1.9
   TOTAL труднее предсказать по ERA/WHIP — требует вдвое больше уверенности.
5. Если нигде нет реального расхождения — верни confidence 0.50 (пропуск).
