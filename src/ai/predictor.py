...
4. Публикуй сигнал ТОЛЬКО если одновременно выполнены все условия:
   - расхождение ≥ 7% (т.е. твоя вероятность минимум на 7 процентных пунктов выше рыночной)
   - уверенность ≥ 0.62
   - кэф ≥ 1.9
   Рынок уже учёл всё очевидное — ставь только при явном перевесе.
5. Если нет котировки с расхождением ≥ 7% — верни confidence 0.50 (пропуск). Это нормально — лучше пропустить игру, чем ставить без реального перевеса.
